...
export async function getSeoSettings(): Promise<SeoSettings> {
  ...
  return {
    ...
    ogTitle: String(data.og_title ?? data.meta_title ?? ""),
    ogDescription: String(data.og_description ?? data.meta_description ?? ""),
    ogImageUrl: String(data.og_image_url ?? ""),
    robotsIndex: data.robots_index !== false && data.robots_index !== "noindex",
    robotsFollow: data.robots_follow !== false && data.robots_follow !== "nofollow",
    robotsMaxImagePreview:
      data.robots_max_image_preview === "none" || data.robots_max_image_preview === "standard"
        ? (data.robots_max_image_preview as "none" | "standard")
        : "large",
    twitterCard:
      data.twitter_card === "summary" ? "summary" : "summary_large_image",
    twitterTitle: String(data.twitter_title ?? ""),
    twitterDescription: String(data.twitter_description ?? ""),
    twitterImageUrl: String(data.twitter_image_url ?? ""),
    googleAnalyticsId: String(data.google_analytics_id ?? ""),
    gtmId: String(data.gtm_id ?? ""),
    facebookPixelId: String(data.facebook_pixel_id ?? ""),
    hreflangEn: String(data.hreflang_en ?? ""),
    hreflangFa: String(data.hreflang_fa ?? ""),
    hreflangXDefault: String(data.hreflang_x_default ?? ""),
...
export async function updateSeoSettings(settings: Partial<SeoSettings>): Promise<SeoSettings> {
  ...
  await apiClient.put(`${ADMIN}/settings/seo`, {
    ...
    robots_index: settings.robotsIndex,
    robots_follow: settings.robotsFollow,
    robots_max_image_preview: settings.robotsMaxImagePreview,
    twitter_card: settings.twitterCard,
    twitter_title: settings.twitterTitle,
    twitter_description: settings.twitterDescription,
    twitter_image_url: settings.twitterImageUrl,
    google_analytics_id: settings.googleAnalyticsId,
    gtm_id: settings.gtmId,
    facebook_pixel_id: settings.facebookPixelId,
    hreflang_en: settings.hreflangEn,
    hreflang_fa: settings.hreflangFa,
    hreflang_x_default: settings.hreflangXDefault,
