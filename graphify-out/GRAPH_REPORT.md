...
## Corpus Check
- 133 files · ~72,886 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 981 nodes · 2011 edges · 70 communities (63 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `54b6963c`
...
- `SignInPage()` --calls--> `useAuth()`  [EXTRACTED]
  src/app/[locale]/(auth)/signin/page.tsx → src/providers/auth-provider.tsx
...
Cohesion: 0.12
Nodes (33): createCategory(), createCoupon(), createOrder(), createPost(), createPostCategory(), createProduct(), delay(), deleteCategory() (+25 more)
...
Cohesion: 0.08
Nodes (24): devDependencies, eslint, eslint-config-next, @eslint/eslintrc, openapi-typescript, prettier, prettier-plugin-tailwindcss, tailwindcss (+16 more)
...
Cohesion: 0.07
Nodes (58): Brand, BrandsPage(), FormData, schema, sections, ProductForm, productSchema, CustomerReviewsPage() (+50 more)

### Community 5 - "Community 5"
Cohesion: 0.14
Nodes (14): cn(), RichTextEditor(), RichTextEditorProps, CardAction(), CardFooter(), Checkbox(), DialogDescription(), DialogOverlay() (+6 more)
...
Cohesion: 0.11
Nodes (32): CouponForm, couponSchema, DashboardPage(), OrderDetailPage(), UserDetailPage(), InvoicePage(), formatCurrency(), formatDate() (+24 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (31): apiClient, ApiError, clearTokens(), getAccessToken(), refreshQueue, setTokens(), Locale, routing (+23 more)
...
Cohesion: 0.09
Nodes (27): mockCategories, mockChartData, mockComments, mockContactMessages, mockCoupons, mockCustomers, mockDashboardStats, mockGeneralSettings (+19 more)
...
Cohesion: 0.18
Nodes (13): authRoutes, getNavIcon(), navigationIcons, navigationConfig, NavItem, publicRoutes, NavLink(), Sidebar() (+5 more)
...
Cohesion: 0.31
Nodes (5): AppLayout(), Header(), useAuth(), LoadingSpinner(), SignUpPage()

### Community 37 - "Community 37"
Cohesion: 0.22
Nodes (10): SalesChart(), getOrders(), StatCard(), ChartDataPoint, Order, Product, Tabs(), TabsContent() (+2 more)
...
## Knowledge Gaps
- **453 isolated node(s):** `__filename`, `__dirname`, `compat`, `eslintConfig`, `withNextIntl` (+448 more)
...
- **Why does `cn()` connect `Community 5` to `Community 4`, `Community 37`, `Community 36`, `Community 6`, `Community 8`, `Community 10`, `Community 13`, `Community 20`, `Community 23`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 4` to `Community 8`, `Community 66`, `Community 5`, `Community 6`?**
